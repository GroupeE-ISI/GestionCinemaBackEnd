...
--
-- Client :  localhost
-- Généré le :  Ven 21 Août 2020 à 10:19
...
CREATE TABLE `film` (
  ...
  `annee_sortie` varchar(20) DEFAULT NULL,
...
INSERT INTO `film` (`id`, `titre`, `description`, `duree`, `annee_sortie`, `photo`, `categorie_id`, `langage_id`) VALUES
(1, 'Le Roi Lion', 'Le long combat de Simba le lionceau pour accéder à son rang de roi des animaux, après que le fourbe Scar, son oncle, a tué son père et pris sa place.', '01:59:00', '2019', 'lion.jpg', 3, 1),
(2, 'Deadpool', 'Deadpool est un mercenaire défiguré doté d\'une capacité surhumaine de guérison accélérée et capable de prouesses physiques. C\'est aussi un mercenaire à la "grande bouche " en raison de sa tendance à discuter et plaisanter constamment.', '01:48:00', '2016', 'deadpool.jpg', 2, 2),
(3, 'La mémoire dans la peau', 'Un agent secret amnésique se rend compte qu\'il sait bien se défendre sans savoir l\'origine de sa force.', '01:59:00', '2002', 'memoire.jpg', 2, 1),
(4, 'Aladdin', 'Comment Aladdin, grâce à la félonie du grand vizir, va se procurer la lampe magique qui héberge le fameux génie et nous entrainer dans la plus étonnante des aventures.', '01:30:00', '1993', 'aladdin.jpg', 3, 1),
(5, 'Docteur Strange', 'Docteur Strange est un Maître des arts mystiques auquel tous les autres super-héros font appel quand ils ont affaire à des adversaires utilisant des pouvoirs occultes.', '01:55:00', '2016', 'strange.jpg', 2, 2),
(6, 'Le Voyage de Chihiro', 'Chihiro, une fillette capricieuse, s\'apprête à emménager avec ses parents dans une nouvelle demeure. La petite famille se retrouve bientôt dans une ville fantôme et les parents se transforment en cochons. Chihiro va tenter de leur porter secours.', '02:05:00', '2001', 'chihiro.jpg', 3, 3),
(7, 'Inception', 'Dom Cobb est un voleur expérimenté dans l\'appropriation des secrets les plus précieux d\'un individu, \r\nenfouis au plus profond de son subconscient, pendant qu\'il rêve et que son esprit est\r\n particulièrement vulnérable.', '02:42:00', '2010', 'inception.jpg', 2, 1);
...
ALTER TABLE `film`
  ...
  ADD KEY `FK472nuunvd4qs51a2kt3uutnpe` (`langage_id`);
...
ALTER TABLE `film`
  ...
  ADD CONSTRAINT `FK472nuunvd4qs51a2kt3uutnpe` FOREIGN KEY (`langage_id`) REFERENCES `langage` (`id`);
